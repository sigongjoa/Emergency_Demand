...
def prediction_plot_n(training, tft ,data, dong , title, ewma_funs, factor,output):
    ...
    for file in sorted(os.listdir('./test_data'))[1:]:
        ...
        xyz['prediction50'] = pred['prediction'][output][idx, : , 3]
        xyz['prediction75'] = pred['prediction'][output][idx, : , 4]
        xyz['prediction90'] = pred['prediction'][output][idx, : , 5]
...
def confusion_matrix_plot50(training, tft ,data ,dong , title, ewma_funs, factor,output):
    # 원본 함수 
...
def confusion_matrix_plot75(training, tft ,data ,dong , title, ewma_funs, factor , output):
    # 원본 함수 
    fig = plt.figure(figsize=(25, 7))
    gs = gridspec.GridSpec(nrows=2, # row 몇 개 
                           ncols=2, # col 몇 개 
...
def confusion_matrix_plot90(training, tft ,data ,dong , title, ewma_funs, factor,output):
    # 원본 함수 
    fig = plt.figure(figsize=(25, 7))
    gs = gridspec.GridSpec(nrows=2, # row 몇 개 
                           ncols=2, # col 몇 개 
